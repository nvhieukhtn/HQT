...
namespace HQT
{
    public partial class StatusBar : UserControl
    {
        ...
        public StatusBar()
        {
            ...
            picHome.MouseHover += new EventHandler(MouseHover);
            picPrevious.MouseHover += new EventHandler(MouseHover);
            picNext.MouseHover += new EventHandler(MouseHover);
            picLogout.MouseHover += new EventHandler(MouseHover);
        }
